...
public class Info3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageList.add(R.drawable.cdmx1);
        imageList.add(R.drawable.cdmx2);
        imageList.add(R.drawable.cdmx3);
        imageList.add(R.drawable.cdmx4);
        ...
        Button btnReservar = findViewById(R.id.reservar3);
    ...
    private void mostrarBottomSheetReserva() {
        ...
        BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(Info3.this);
        ...
        etFecha.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(Info3.this,
        ...
        btnFinalizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (nombre.isEmpty() || telefono.isEmpty() || correo.isEmpty() || fecha.isEmpty()) {
                    Toast.makeText(Info3.this, "Por favor, complete todos los campos", Toast.LENGTH_SHORT).show();
                } else {
                    // Aquí puedes manejar la lógica de la reserva, como enviar los datos a tu servidor
                    Toast.makeText(Info3.this, "Reserva realizada", Toast.LENGTH_SHORT).show();
