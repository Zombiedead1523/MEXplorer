...
public class Info4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageList.add(R.drawable.chiapas1);
        imageList.add(R.drawable.chiapas2);
        imageList.add(R.drawable.chiapas3);
        imageList.add(R.drawable.chiapas4);
        ...
        Button btnReservar = findViewById(R.id.reservar4);
    ...
    private void mostrarBottomSheetReserva() {
        ...
        BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(Info4.this);
        ...
        etFecha.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(Info4.this,
        ...
        btnFinalizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (nombre.isEmpty() || telefono.isEmpty() || correo.isEmpty() || fecha.isEmpty()) {
                    Toast.makeText(Info4.this, "Por favor, complete todos los campos", Toast.LENGTH_SHORT).show();
                } else {
                    // Aquí puedes manejar la lógica de la reserva, como enviar los datos a tu servidor
                    Toast.makeText(Info4.this, "Reserva realizada", Toast.LENGTH_SHORT).show();
