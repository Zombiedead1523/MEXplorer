...
public class Info2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageList.add(R.drawable.cancun1);
        imageList.add(R.drawable.cancun2);
        imageList.add(R.drawable.cancun3);
        imageList.add(R.drawable.cancun4);
        ...
        Button btnReservar = findViewById(R.id.reservar2);
    ...
    private void mostrarBottomSheetReserva() {
        ...
        BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(Info2.this);
        ...
        etFecha.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(Info2.this,
        ...
        btnFinalizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (nombre.isEmpty() || telefono.isEmpty() || correo.isEmpty() || fecha.isEmpty()) {
                    Toast.makeText(Info2.this, "Por favor, complete todos los campos", Toast.LENGTH_SHORT).show();
                } else {
                    // Aquí puedes manejar la lógica de la reserva, como enviar los datos a tu servidor
                    Toast.makeText(Info2.this, "Reserva realizada", Toast.LENGTH_SHORT).show();
